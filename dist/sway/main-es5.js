...
var CartComponent = /** @class */ (function () {
    ...
    CartComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.params.subscribe(function (params) {
            ...
            if (id) {
                var item = {
                    product: _this.productService.select(id),
                    quantity: 1
                };
    ...
    CartComponent.prototype.onIncrement = function () {
        this.votes += 1;
    };
    CartComponent.prototype.onDecrement = function () {
        this.votes -= 1;
    };
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.select = function (id) {
